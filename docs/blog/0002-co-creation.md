...
- **Ideas seeded** — mission, values, default SOPs, regulatory tracker (when relevant). The reference shape: AEIQ ships with 45 Ideas out of the gate.
- **Events scheduled** — daily standups, weekly reviews, monthly compliance checks, quarterly board prep. 28 in the AEIQ reference. Paused by default; you flip them on as you need them.
